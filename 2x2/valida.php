...
echo'<b>Sistemas Lineares (2x2)</b><br>';
echo'D é igual a zero, logo não há raizes reais';
...
echo'A diagonal Secundaria D é '.$d2.'<br>';
echo'O valor de D é  '.$determinante.'<br><br>';

echo'A diagonal Principal Dx é '.$dx1.'<br>';
echo'A diagonal Secundaria Dx é '.$dx2.'<br>';
echo'O valor de Dx é '.$dx.'<br>';
echo'O valor de X é '.$x.'<br><br>';

echo'A diagonal Principal  de Dy é '.$dy1.'<br>';
echo'A diagonal Secundaria de Dy é '.$dy2.'<br>';
echo'O valor de Dy é '.$dy.'<br>';
